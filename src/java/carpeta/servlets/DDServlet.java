...
public class DDServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Diagrama Despliegue</title>");
            ...
            out.println("<h1>CREACIÓN DE DIAGRAMAS DESPLIEGUE (DEPLOYMENT)</h1>");
            out.println("<div class='btnNuevo'>");
            out.println("<input type='submit' value='Crear nuevo Diagrama de Despliegue'>");
            out.println("</div>");
            out.println("<div>");
            out.println("<table>");
            out.println("<tr>");
            out.println("<th>Nombre del Diagrama de Despliegue</th>");
